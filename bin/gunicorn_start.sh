...
VIRTUALENV=$ENV_DIR/bin/             # Django project directory
PROJ_DIRECTORY=$PROJECT_DIR             # Django project directory
SOCKFILE=$HOME_DIR/gunicorn.sock  # we will communicte using this unix socket
...
#WORKER_CLASS=gevent
TIMEOUT=1000
ERROR_LOG_FILE=$LOGS_DIR/gunicorn_error.log
...
export LSS_ENV=$ENVIRONMENT_TYPE
